      ...
      return (
        <div className="checkout-summary">
          <div className="form-header">
            <h2>
            Итог<span className="hide-content">
                {' '}
                по вашему заказу.
              </span>
            </h2>
          ...
          <div className="price-calculations">
            <div className="price-item">
              Промежуточный итог<span className="hide-content"> для всех продуктов.</span>
            ...
            <div className="price-item">
              Налог: <span className="price">{tax+'₸'}</span>
            </div>
            <div className="price-item">
              Доставка: <span className="price">0₸</span>
            </div>
          </div>
