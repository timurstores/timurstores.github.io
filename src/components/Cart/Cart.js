...
class Cart extends Component {
  ...
  render() {
    ...
    if (
      ...
      if (cart.cart.data[0]) {
        var subtotal =cart.cart.meta.display_price.with_tax.amount+"₸" ;
        return (
          <div>
            <MobileNav />
            <CartHeader />
                ...
                <div className="content">
                  <form className="cart-listing" method="post" noValidate>
                    <div className="cart-list-headings">
                      <div className="cart-product-header">Продукты</div>
                      <div className="cart-header-group">
                        <div className="cart-empty-header" />
                        <div className="cart-quantity-header">Количество</div>
                        <div className="cart-price-header">Цена</div>
                      </div>
                    </div>
                    <CartItems />
                    <div className="total-price">
                      Промежуточный итог<span className="hide-content">
                        {' '}
                        всех продуктов
                      </span>{' '}
              ...
              <section className="cart">
                <div className="content">
                  <div className="cart-listing empty">
                    <p>
                      Кажется у вас нет выбранных продуктов.
                    </p>
